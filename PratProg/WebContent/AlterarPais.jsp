                    ...
                    <form action="ManterPais.do" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="populacao" class="form-control" name="populacao" id="populacao" maxlength="15" placeholder="digite a populacao" value="${pais.populacao}">
                            </div>

                            <div class="form-group col-md-6">
                                <label for="email">Area</label>
                                <input type="area" class="form-control" name="area" id="area" required maxlength="60" placeholder="digite a area" value="${pais.area }">
                            </div>
                        </div>
                        <hr />
